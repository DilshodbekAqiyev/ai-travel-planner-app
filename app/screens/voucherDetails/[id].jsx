...
export default function VoucherDetails() {
  ...
  useEffect(() => {
    ...
    const vouchers = [
      { id: "1", name: "Tealive RM5 Off", points: 500, image: "https://static.wixstatic.com/media/2c0fab_5fb1c9d1510e42ac86ad8bad39dad922~mv2.png/v1/fill/w_560,h_564,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Pavi-Bkt-Jalil-3.png", description: "Enjoy a RM5 discount at Tealive." },
      { id: "2", name: "Sunway Lagoon RM30 Off", points: 2500, image: "https://www.pelago.com/img/products/MY-Malaysia/sunway-lagoon-amusement--water-park/f232c683-08bf-4fd0-b7a8-025cbbef03a7_sunway-lagoon-theme-park.jpg", description: "Get RM30 off your Sunway Lagoon ticket." },
      { id: "3", name: "Bobbi Brown 15%", points: 200, image: "https://www.chagee.com.sg/_next/image?url=https%3A%2F%2Foss.chagee.com.sg%2Fwebsite2025%2Fuploads%2F20240607%2F8cd78dd3-be24-4e53-af47-9018dd6e1d6c.png&w=1920&q=100", description: "Save 15% on Bobbi Brown products." },
    ];
